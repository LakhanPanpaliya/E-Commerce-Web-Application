...
function CardItems() {
  ...
  function getEstimatedTax() {
    return Number((getTotalSum() * 0.1).toFixed(2));
  }
  ...
  return (
    <div className="shoopingCarddiv">
              ...
              <div className="right-side"> 
                ...
                <div className="subtotal-delete">
                  <div className="subtotal"> 
                    <h2>$ {getSubTotal(product.price, product.quantity)} </h2>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="billingSection">
        ...
        <button className="chekoutBtn">
          Proceed To checkout <ShoppingBagIcon fontSize="medium" />{" "}
        </button>
